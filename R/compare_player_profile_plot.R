#' Player Profile Comparison Plot
#'
#'@description
...
compare_player_profile_plot <- function (player_profile_1, player_profile_2)
{
  UseMethod("compare_player_profile_plot")
}

#' @export

compare_player_profile_plot.default <- function(player_profile_1, player_profile_2) {

  p1 <- compare_profile_plot1(player_profile_1)

  par(mfrow = c(1,1))

  p1
  lines(speed ~ time_splits, player_plot_values(player_profile_2), col = "red")
  lines(acceleration ~ time_splits, player_plot_values(player_profile_2), col = "red")
